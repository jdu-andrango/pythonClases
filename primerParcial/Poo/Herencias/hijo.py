...
class Hijofinal(Padre, Madre):
    ...
    def __init__(self, nombre, apellidoPaterno, apellidoMaterno, edad, ciudad, apellido, padre, madre):
...
hijofinal  = Hijofinal("Diego",  "Molina", "Hernandez", 29, "Quito", Padre("German", "Molina", 55, "Quito"), Madre("Rosario", "Hernandez", 54, "Ambato"))
# hijofinal  = Hijofinal()
